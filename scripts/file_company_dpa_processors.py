...
PRIOR_ATTEMPTED = {
    ...
    "neon",
    "nightfall",
    # this cut — upper-quadrant subprocessors batch (2 filed)
    "synchronoss",
    "g-data-cyberdefense",
    "rocket-lawyer",
    "sauce-labs",
    ...
    "bodyguard-ai",
    "censys",
    # this cut — upper-quadrant subprocessors batch (5 filed)
    "cloud-convert",
    "data-zoo",
    "digicert",
    "elliptic",
    ...
    "wind-river-systems",
    "pkware",
    # this cut — upper-quadrant subprocessors batch (4 filed)
    "telus",
    ...
    # this cut — upper-quadrant subprocessors batch (0 filed)
    "monetate",
    ...
    "absolute-security",
    "accion-labs-us",
    # this cut — upper-quadrant subprocessors batch (3 filed)
    "accordance",
    "acorns",
    ...
    "zspace",
    "zuken",
    # this cut — leftover-company Completeness fill (4 DPA, 6 named lists)
    "planhat",
    "rev",
    "timescale",
    "jitsu",

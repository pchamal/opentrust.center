...
expect("dossier processors missing have no smear", !dossier.includes("Not a complete supply chain") && !dossier.includes("not a complete supply chain") && !dossier.includes("Filed from the company’s public list") && !/sec-kicker">Named processors[\s\S]*src-line/.test(dossier));

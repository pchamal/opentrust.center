...
def main() -> int:
    ...
    zoom_html = (ROOT / "site" / "c" / "zoom.html").read_text(encoding="utf-8")
    check("01 April 2025" not in zoom_html, "zoom dossier dropped 01 April 2025")
    check("Date of change" not in zoom_html, "zoom dossier dropped Date of change")
